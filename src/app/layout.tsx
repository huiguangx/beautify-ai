...
export const metadata: Metadata = {
  title: "Beautify拼豆底稿生成器 | Perler Beads Generator",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased overflow-x-hidden text-gray-900 dark:text-gray-100`}
